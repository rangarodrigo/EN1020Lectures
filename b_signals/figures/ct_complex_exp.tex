...
%     axis x line=middle,
     ...
     %xticklabel style={anchor=north west}
      ...
      \addplot[domain=-5:5,samples=200,EntcMaroonDef]{exp(\r*x)*cos(2*pi*deg(x))};
      \addplot[domain=-5:5,samples=200,EntcBlue, dashed]{exp(\r*x)}
                                node[right,pos=1,font=\footnotesize, black]{\scriptsize $e^{rt}$};
                                      \addplot[domain=-5:5,samples=200,blue, dashed]{-exp(\r*x)}
                                node[right,pos=1,font=\footnotesize, black]{\scriptsize $-e^{rt}$};
       \node at (axis cs:1.5, 8) [anchor=west] {\scriptsize $r>0$, $\phi=0$  };
    \end{axis}
     ...
     %xticklabel style={anchor=north west}
      ...
      \addplot[domain=-5:5,samples=200,EntcBlue, dashed]{exp(\r*x)}
                                node[right,pos=0,font=\footnotesize, black]{\scriptsize $e^{rt}$};
                                      \addplot[domain=-5:5,samples=200,blue, dashed]{-exp(\r*x)}
                                node[right,pos=0,font=\footnotesize, black]{\scriptsize $-e^{rt}$};
       \node at (axis cs:2, 8) [anchor=west] {\scriptsize $r<0$, $\phi=0$ };
    \end{axis}
