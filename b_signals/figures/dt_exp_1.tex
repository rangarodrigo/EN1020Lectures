...
\addplot+[ycomb,EntcBlue, mark options={black, mark size=1}] table [x={n}, y={xn}] {b_signals/figures/dt_exp_alpha_neg_less_than_one.dat};
...
\addplot+[ycomb,EntcBlue, mark options={black, mark size=1}] table [x={n}, y={xn}] {b_signals/figures/dt_exp_alpha_neg_greater_than_one.dat};
