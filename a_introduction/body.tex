...
\begin{frame}{Introduction to Course Contd.}
    \begin{itemize}[<+->]
        ...
        \item Types of signals in continuous time and discrete time, linear time-invariant (LTI) systems, Fourier series are the core components of the signals and systems part of this course.
